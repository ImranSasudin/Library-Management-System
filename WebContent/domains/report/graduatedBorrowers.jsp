       			 ...
       			 <div id="container" class="container">
          			  <div class="row text-black">
               			 <div class="col-lg-8 offset-sm-2 text-center">
                 			   <h1 class="display-5">Graduated Borrowers</h1><br/>
                 			   <p >(Not return book(s) yet)<p>
                 			   <div class="text-left">
                 			   </div>
                   				 <div class="info-form">
                          			  ...
                          			  <table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
  										<thead>
   										 <tr>
     										 ...
     										 <th class="th-sm">Book Not Return</th>
  										...
  										<tbody>
  											<c:forEach items="${reports}" var="report">
    											<tr>
    												<td><a href="/Library/ReportController?action=viewPatron&type=Student&report=graduatedBorrowers&patronID=${report.patronID}" class="text-primary"><c:out value="${report.patronID}" /></a></td>
													<td><c:out value="${report.patronName}" /></td>
													<td><a href="/Library/ReportController?action=viewBook&report=graduatedBorrowers&bookISBN=${report.bookISBN}" class="text-primary"><c:out value="${report.bookName}" /> (ISBN: <c:out value="${report.bookISBN}" />)</a></td>
