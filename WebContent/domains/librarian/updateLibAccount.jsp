                 			   ...
                 			   <h1 class="display-5">My Account</h1>
                   				 <div class="info-form">
                          			  ...
                          			  <div class="form-group">
                              			...
                              			<input type="text" name="libID" class="form-control border border-light" value="<c:out value="<%=libID %>" />" readonly>
                           			 </div>
                           			 <div class="form-group">
                          			  	<br/>
                          			  	<h3 class="text-left">Name :</h3>
                              			<input type="text" name="libName" class="form-control border border-light" value="${librarian.libName}" pattern="^[_A-z]*((-|\s)*[_A-z])*$" title="Name cannot contain any special character or number" required>
                           			 </div>
                           			  <div class="form-group">
                          			  	<br/>
                          			  	<h3 class="text-left">Password :</h3>
                          			  	<a href="/Library/domains/librarian/updatePass.jsp" class="btn btn-primary">Update Password</a>
                           			 </div>
                                     <div class="form-group">
                          			  	<br/>
                          			  	...
                          			  	<c:choose>
                          			  	 	<c:when test="${librarian.managerID == null || librarian.managerID == 0}">
                          			  			<input type="text" name="managerID" class="text-left form-control border border-light" value="No Manager" readonly>
                          			  		</c:when>
                          			  	<c:otherwise>
                          			  		<c:forEach items="${librarians}" var="headLib">
                          			  			<c:choose>
                          			  				<c:when test="${librarian.managerID == headLib.libID}">
                          			  					<input type="text" name="managerID" class="text-left form-control border border-light" value="<c:out value="${headLib.libName}"/> (ID : <c:out value="${headLib.libID}" />)"  readonly>
                          			  				</c:when>
                          			  			</c:choose>
                          			  		</c:forEach>
                          			  	</c:otherwise>
                           			 ...
                           			 <div class="form-group">
                              			...
                              			<input type="text" name="libRole" class="form-control border border-light" value="${librarian.libRole}" readonly>
                           			 </div>
