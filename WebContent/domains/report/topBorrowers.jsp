       			 ...
       			 <div id="container" class="container">
          			  <div class="row text-black">
               			 <div class="col-lg-8 offset-sm-2 text-center">
                 			   <h1 class="display-5">Top Borrowers (Student Only)</h1>
                 			   <div class="text-left">
                 			   </div>
                   				 <div class="info-form">
                          			  ...
                          			  <table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
  										<thead>
   										 <tr>
     										 ...
     										 <th class="th-sm">Books Borrowed</th>
  										...
  										<tbody>
  											<c:forEach items="${reports}" var="report">
    											<tr>
    												<td><a href="/Library/ReportController?action=viewPatron&type=Student&report=topBorrowers&patronID=${report.patronID}" class="text-primary"><c:out value="${report.patronID}" /></a></td>
